#!/usr/bin/python3
#-*-coding:utf-8-*-
#Recoded by Alif Nurdin (SyachPutra78)
#Designed by Alif Nurdin (SyachPutra78
...
###------------[TUNGGU SEBENTAR SEDANG INSTALLING MODULES]----------------####
try:
...
def XyzTimeZone():
	now = datetime.now()
	hours = now.hour
	if 4 <= hours < 12:timenow = "Good Morning di script Fui"
	elif 12 <= hours < 15:timenow = "Good Afternoon di script fui"
	elif 15 <= hours < 18:timenow = "Good Evening di script fui"
	else:timenow = "Good Night tunda dulu main termuxnya"
	return timenow
...
{R2}░█░░░░█▃▃█░░█░ INDONESIA
{R2}🇦​​🇺​​🇹​​🇭​​🇴​​🇷​ : SyachPutra78
{R2}🇬​​🇮​​🇹​​🇭​​🇺​​🇧​ : https://github.com/SyachPutra78
{R2}🇫​​🇦​​🇨​​🇪​​🇧​​🇴​​🇴​​🇰​ : https://www.facebook.com/profile.php?id=100076695461489&mibextid=kFxxJD""",subtitle=f"1.0.0",title=f"{B2}{XyzTimeZone()}",width=80,padding=(0,4),style=f"#FFFFFF"))
...
def SyachPutra78():
			...
			if xd in ['1','01']:
				...
				younisjohn.print(Columns(SyachPutra78))
				...
				print('\n\t\033[0;91m Option not found!');time.sleep(2); SyachPutra78()
...
def pak():
		...
		SyachPutra78.print(Columns(SyachPutra78))
